package org.statismo.support.nativelibs.jogl.troubleshoot.gl3;
...
// stolen from: http://miksblog.capcaval.org/2013/07/jogl-gl3-sample/
...
public class GL3Sample implements GLEventListener {
    ...
    public GL3Sample(String title, GLProfile profile, int x, int y, int frameWidth, int frameHeight) {
// allocate a frame and display the openGL inside it
        JFrame frame = newJFrame("[GL3] "+title,
                this, x, y, frameWidth, frameHeight, profile);
...
// display it and let's go
    ...
    public static JFrame newJFrame(String name, GLEventListener sample, int x,
                                   int y, int width, int height, GLProfile glp) {
